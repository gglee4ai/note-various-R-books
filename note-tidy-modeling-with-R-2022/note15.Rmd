...
grid_results_time_start <- Sys.time()
grid_results <-
  all_workflows %>%
  workflow_map(
    seed = 1503,
...
grid_results_time_stop <- Sys.time()
```
...
race_results_time_start <- Sys.time()
race_results <-
  all_workflows %>%
  workflow_map(
    "tune_race_anova",
...
race_results_time_stop <- Sys.time()
```
...
```{r}
grid_results_time_stop - grid_results_time_start
```

```{r}
race_results_time_stop - race_results_time_start
```
