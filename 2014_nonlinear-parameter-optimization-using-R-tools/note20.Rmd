...
```{r}
tspan <- c(
  0, 8, 13, 20, 29, 34, 41, 50, 56, 62,
  71, 78, 83, 91, 99, 104, 111, 120, 127, 134,
  139, 148, 155, 160
)
data <- c(
  115, 59, 69, 142, 390, 2990, 4700, 5488, 5620, 6399,
...
MLoptres <- optim(params, LLode, method = "Nelder-Mead", control = list(trace = 0, maxit = 5000))
MLoptres
```
...
if (!file.exists("./tmpdata/C20opresult.dput")) {
  optxres <- optimx(params, LLode,
    lower = rep(0, 4), upper = rep(500, 4),
